...
public class PreGamePage extends JFrame implements ButtonBindable{
	...
	public PreGamePage(int gamesize, JFrame father) {
	...
	public void refresh() {
		// TODO Auto-generated method stub
		this.gamesize = ((MainPage)this.father).getGamesize();
	}
